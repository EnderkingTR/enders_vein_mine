...
public class BlockUtils {
    ...
    public static boolean isSameBlockGroup(BlockState targetState, BlockState currentState) {
        ...
        Set<TagKey<Block>> targetTags = targetState.getBlock().builtInRegistryHolder().tags().collect(Collectors.toSet());
        Set<TagKey<Block>> currentTags = currentState.getBlock().builtInRegistryHolder().tags().collect(Collectors.toSet());
