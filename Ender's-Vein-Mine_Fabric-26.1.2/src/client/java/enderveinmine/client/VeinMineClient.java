...
public class VeinMineClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        KeyMapping.Category category = KeyMapping.Category.register(enderveinmine.VeinMine.id("category.vein-mine"));
        ...
        nextShapeKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
        ...
        prevShapeKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (settingsKey.consumeClick()) {
                client.setScreenAndShow(VeinMineSettingsScreen.create(null));
            }
        ...
        net.fabricmc.fabric.api.client.rendering.v1.level.LevelRenderEvents.COLLECT_SUBMITS.register(new BlockOutlineRenderer());
    }
