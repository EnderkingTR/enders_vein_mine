...
public class BlockOutlineRenderer implements WorldRenderEvents.EndMain {
    ...
    public void endMain(WorldRenderContext context) {
        ...
        double camX = context.worldState().cameraRenderState.pos.x;
        double camY = context.worldState().cameraRenderState.pos.y;
        double camZ = context.worldState().cameraRenderState.pos.z;
        ...
        // Draw lines first
        com.mojang.blaze3d.vertex.VertexConsumer consumer = context.consumers().getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.lines());
        for (BlockPos pos : cachedBlocks) {
            ...
            shape.forAllBoxes((minX, minY, minZ, maxX, maxY, maxZ) -> {
                ...
                consumer.addVertex(pose, fMinX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(1, 0, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(1, 0, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMaxY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 0, 1).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMinY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, 0, 1).setLineWidth(2.0f);
                
                consumer.addVertex(pose, fMaxX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(-1, 0, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(-1, 0, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, -1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMinY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, -1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, 0, -1).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMaxY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 0, -1).setLineWidth(2.0f);
                
                consumer.addVertex(pose, fMinX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, -1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMinY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, -1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMaxY, fMaxZ).setColor(red, green, blue, alpha).setNormal(1, 0, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMinX, fMaxY, fMinZ).setColor(red, green, blue, alpha).setNormal(1, 0, 0).setLineWidth(2.0f);
                
                consumer.addVertex(pose, fMaxX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMaxY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 1, 0).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMinY, fMinZ).setColor(red, green, blue, alpha).setNormal(0, 0, 1).setLineWidth(2.0f);
                consumer.addVertex(pose, fMaxX, fMinY, fMaxZ).setColor(red, green, blue, alpha).setNormal(0, 0, 1).setLineWidth(2.0f);
            });
        }
        
        // Draw filled quads second
        com.mojang.blaze3d.vertex.VertexConsumer quadConsumer = context.consumers().getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.debugFilledBox());
        for (BlockPos pos : cachedBlocks) {
            BlockState state = level.getBlockState(pos);
            if (state.isAir()) continue;
            ...
            shape.forAllBoxes((minX, minY, minZ, maxX, maxY, maxZ) -> {
                ...
                // Draw filled box (6 faces, 4 vertices per face)
                // Bottom
