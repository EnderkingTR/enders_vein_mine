...
public class ClientSetup {
    ...
    public static void registerBindings(RegisterKeyMappingsEvent event) {
        String category = "key.categories.vein_mine";
    ...
    public static void sendActiveState(boolean active) {
        PacketDistributor.sendToServer(new VeinMineActivePayload(active));
    }

    public static void sendConfigToServer() {
        PacketDistributor.sendToServer(VeinMineConfigPayload.fromConfig());
    }
